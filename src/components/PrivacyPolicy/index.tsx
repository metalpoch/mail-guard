  ...
  return (
    <div>
      ...
      <div className="p-5 lg:px-28">
        ...
        <p>
          At Mail Guard, accessible from mail-guard.vercel.app, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Mail Guard and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Mail Guard. This policy is not applicable to
        ...
        <p>
          Mail Guard follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of Mail Guard.
        </p>
        ...
        <p>
          Note that Mail Guard has no access to or control over these cookies
        ...
        <p>
          Mail Guard does not knowingly collect any Personal Identifiable
